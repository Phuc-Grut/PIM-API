...
{
    public partial class ProductTagConfiguration : IEntityTypeConfiguration<ProductTag>
    {
        public void Configure(EntityTypeBuilder<ProductTag> entity)
        {
            entity.ToTable("ProductTag", "pim");
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<ProductTag> entity);
    }
}
