...
namespace VFi.NetDevPack.Context
{
    public class ContextUser : IContextUser
    {
        ...
        public string Tenant
        {
            get
            {
                if (!string.IsNullOrEmpty(this.RuntimeTenant)) return this.RuntimeTenant;
        ...
        public string Data_Zone
        {
            get
            {
                if (!string.IsNullOrEmpty(this.RuntimeData_Zone)) return this.RuntimeData_Zone;
        ...
        public string Data
        {
            get
            {
                if (!string.IsNullOrEmpty(this.RuntimeData)) return this.RuntimeData;
