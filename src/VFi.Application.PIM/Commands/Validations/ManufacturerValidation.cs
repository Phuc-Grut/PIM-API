...
{
    public abstract class ManufacturerValidation<T> : AbstractValidator<T> where T : ManufacturerCommand

    {
        protected readonly IManufacturerRepository _context;
        private Guid Id;
        public ManufacturerValidation(IManufacturerRepository context, Guid id)
        {
            _context = context;
            Id = id;
        }
        public ManufacturerValidation(IManufacturerRepository context)
        {
            _context = context;
        }
    ...
    public class ManufacturerAddCommandValidation : ManufacturerValidation<ManufacturerAddCommand>
    {
        public ManufacturerAddCommandValidation(IManufacturerRepository context) : base(context)
        {
            ValidateId();
            ValidateStatus();
    ...
    public class ManufacturerEditCommandValidation : ManufacturerValidation<ManufacturerEditCommand>
    {
        public ManufacturerEditCommandValidation(IManufacturerRepository context, Guid id) : base(context, id)
        {
            ValidateId();
            ValidateIdExists();
            ValidateStatus();
    ...
    public class ManufacturerDeleteCommandValidation : ManufacturerValidation<ManufacturerDeleteCommand>
    {
        public ManufacturerDeleteCommandValidation(IManufacturerRepository context) : base(context)
        {
            ValidateId();
            ValidateIdExists();
        }
